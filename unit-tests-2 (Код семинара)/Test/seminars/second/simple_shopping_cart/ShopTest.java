...
class ShopTest {
    ...
    // private Shop shop;
    // private Cart cart;
    //  @BeforeEach  // эта аннотация используется, чтобы удалить повторяющиеся строки из всех тестов
                    // и можно удалить из всех последующих тестов код из секции
    //              // Arrange (Подготовка)
...
*/
    ...
    void deletedProductIsReturnedToShop() {
        ...
        cart.addProductToCartByID(1); // 5
        cart.addProductToCartByID(1); // 6
        // Сейчас в корзине д.б. 6 продуктов с id 1(0), в магазине - 4
        // Assert (проверка утверждения)
    ...
    @Disabled  // эта аннотация используется для отключения теста
